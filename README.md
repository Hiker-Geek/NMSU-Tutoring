...
2. When creating branches checkout the main branch locally first (git checkout main), do git pull to update main, then git checkout -b <new branch>
...
6. NEVER MERGE INTO MAIN IF YOUR CODE HAS ERRORS. Always resolve errors before merging into main.
